...
namespace TestDemo
{
    public partial class FormCalculateAreas : Form
    {
        public FormCalculateAreas()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (System.IO.File.Exists(WhetherFileExist) == false) //判断输出文件是否存在
            {
                ...
                calculateAreas(textBox1.Text.ToString(), textBox2.Text.ToString());
            }
            else
            {
        ...
        public void calculateAreas(string inshapefile, string outshapefile)
        {
            ESRI.ArcGIS.Geoprocessor.Geoprocessor GP = new ESRI.ArcGIS.Geoprocessor.Geoprocessor();
            GP.OverwriteOutput = true;
            ESRI.ArcGIS.SpatialStatisticsTools.CalculateAreas fpg = new ESRI.ArcGIS.SpatialStatisticsTools.CalculateAreas();
            ...
            fpg.Input_Feature_Class = inshapefile; //参数1
            fpg.Output_Feature_Class  = outshapefile; //参数2
