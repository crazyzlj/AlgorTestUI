...
namespace TestDemo
{
    ...
    public sealed class OpenAttributeTable : BaseCommand
    {
        ...
        public OpenAttributeTable(ILayer pLayer,IMapServer pMapServer)
        {
            ...
            base.m_caption = "打开属性表到新窗口"; //localizable text
            base.m_message = "打开属性表到新窗口"; //localizable text 
            base.m_toolTip = "打开属性表到新窗口"; //localizable text 
            base.m_name = "打开属性表到新窗口"; //unique id, non-localizable (e.g. "MyCategory_MyCommand")
            m_pLayer = pLayer;
        ...
        public OpenAttributeTable(ILayer pLayer,DataGridView gridview,TabPage tab)
        {
            ...
            base.m_message = "查看属性表"; //localizable text 
            base.m_toolTip = "查看属性表"; //localizable text 
            base.m_name = "查看属性表"; //unique id, non-localizable (e.g. "MyCategory_MyCommand")
            m_pLayer = pLayer;
