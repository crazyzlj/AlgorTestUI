...
namespace AlgorithmTest
{
    ...
    public class CreateNewDocument : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            {
                result = MessageBox.Show("是否保存所作的编辑？", "保存编辑内容", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            ...
            DialogResult res = MessageBox.Show("是否保存当前地图?", "保存", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
